    ...
    return (
        <>
            <header id={styles.headerbar}>
                ...
                <img src="http://img.sbs.co.kr/newimg/news/20170406/201037558.png" alt="" className={styles.social} id={styles.twitter}/>
                <img src="http://img.sbs.co.kr/newimg/news/20170406/201037559.png" alt="" className={styles.social} id={styles.facebook}/>
            </header>
        </>
    );
};
